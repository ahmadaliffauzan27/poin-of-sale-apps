...
class DiscountResponsesModel {
  final String? status;
  final List<Discount>? data;

  DiscountResponsesModel({
    this.status,
    this.data,
  });

  factory DiscountResponsesModel.fromJson(String str) =>
      DiscountResponsesModel.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory DiscountResponsesModel.fromMap(Map<String, dynamic> json) =>
      DiscountResponsesModel(
        status: json["status"],
        data: json["data"] == null
            ? []
